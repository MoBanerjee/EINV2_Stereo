...
# eval set
DATASET='STARSS22' 
python3 code/main.py -c $CONFIG_FILE --dataset=$DATASET preprocess --preproc_mode='extract_data' --dataset_type='eval' 
python3 code/main.py -c $CONFIG_FILE --dataset=$DATASET preprocess --preproc_mode='extract_indexes' --dataset_type='eval'
